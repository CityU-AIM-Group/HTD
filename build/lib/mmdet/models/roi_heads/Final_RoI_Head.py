...
class FinalRoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def _fuse_glbctx(self, roi_feats, global_feat, rois):
    ...
    def _bbox_forward(self, stage, x, rois, global_feat=None, sampling_results=None,img_metas=None):
        ...
        if stage == 0:
            ...
            bbox_feats = bbox_roi_extractor(x[:bbox_roi_extractor.num_inputs],
                                            rois)
            # if self.with_glbctx:
            #     bbox_feats = self._fuse_glbctx(bbox_feats, global_feat, rois)
            ...
            if sampling_results:
                ...
                bbox_feats_reg[:num_pos_1] += bbox_feats[:num_pos_1]
                bbox_feats_reg[num_pos_1:] += bbox_feats[num_pos_1:num_pos_1+num_pos_2]


                cls_score, bbox_pred = bbox_head(bbox_feats,bbox_feats_reg, x[:bbox_roi_extractor.num_inputs], rois, self.bbox_head[0].fc_cls, global_feat=global_feat)
    ...
    def _bbox_forward_train(self, stage, x, sampling_results, gt_bboxes,
        ...
        # else:
        #     loss_bbox = self.bbox_head[stage].loss(bbox_results['cls_score'],
        #                                            bbox_results['bbox_pred'], bbox_results['bbox_pred2'], rois,
        #                                            *bbox_targets)
