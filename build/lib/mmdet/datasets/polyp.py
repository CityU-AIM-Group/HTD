...
class COCOeval_modified(COCOeval):
...
class PolypCocoDataset(CustomDataset):
    ...
    def evaluate(self,
        ...
        if iou_thrs is None:
            iou_thrs = np.linspace(
                ...
                .25, 0.75, int(np.round((0.75 - .25) / .05)) + 1, endpoint=True)
        ...
        for metric in metrics:
            ...
            cocoEval = COCOeval_modified(cocoGt, cocoDt, iou_type)
            ...
            if metric == 'proposal':
                ...
                if metric_items is None:
                    metric_items = [
                        'mAP','mAP_25', 'mAP_50', 'mAP_75', 'mAP_s', 'mAP_m', 'mAP_l'
                    ]
