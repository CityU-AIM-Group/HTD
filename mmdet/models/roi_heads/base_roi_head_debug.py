...
class HDSLRoIHeadDebug(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(HDSLRoIHeadDebug, self).__init__(
    ...
    def _fuse_glbctx(self, roi_feats, glbctx_feat, rois):
        ...
        return fused_feats
    def _bbox_forward(self, stage, x, rois, glbctx_feat=None, sampling_results=None,img_metas=None):
    ...
    def _bbox_forward_train(self, stage, x, sampling_results, gt_bboxes,
                            gt_labels, rcnn_train_cfg, img_metas, glbctx_feat=None):
    ...
    def simple_test(self, x, proposal_list, img_metas, rescale=False):
        ...
        #--------------------------------Stage 2: Graph Reasoning--------------------------------------------
        bbox_results = self._bbox_forward(1, x, rois, glbctx_feat)
        cls_score = bbox_results['cls_score']
        bbox_pred = bbox_results['bbox_pred']
        num_proposals_per_img = tuple(
            len(proposals) for proposals in proposal_list)
    ...
    def aug_test(self, features, proposal_list, img_metas, rescale=False):
        ...
        for x, img_meta in zip(features, img_metas):
            ...
            for i in range(self.num_stages):
                bbox_results = self._bbox_forward(i, x, rois ,glbctx_feat)
